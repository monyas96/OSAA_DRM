...
try:
    from app.app_core.components.navigation import render_navigation_buttons, render_page_logo
...
# --- Load OSAA CSS ---
try:
    with open(str(root_dir / "app" / "app_core" / "styles" / "style_osaa.css")) as f:
...
<div class="hero-section">
    <div class="hero-logo">
        <img src="assets/logos/OSAA identifier color.png" alt="OSAA Logo" style="max-width: 200px; max-height: 80px;">
    </div>
