      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="prose max-w-none">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg mb-8">
            <h3 className="text-base font-bold text-[#003366] mb-3">The Two-Pillar Strategy</h3>
          ...
          {/* The Prize Box */}
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 border-2 border-teal-300 p-6 rounded-xl mb-8">
            <h3 className="text-base font-bold text-teal-900 mb-3">The Prize</h3>
