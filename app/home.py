...
# Add current directory to path (app_streamlit.py is in root, not pages/)
...
topic_pages = {
    "4.1": "pages/3_topic_4_1.py",
    "4.2": "pages/4_topic_4_2.py",
    "4.3": "pages/5_topic_4_3.py",
    "4.4": "pages/6_topic_4_4.py",
    "data-availability": "pages/7_data_availability.py",
}
