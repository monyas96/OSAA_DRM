"""
Policy Brief Graph: Indicator 4.1.2.1 - PEFA: PI-2 Expenditure composition out-turn
Pre-configured Streamlit page showing Spending Alignment with Priorities
...
from app.pages.pb_graph_helpers import render_pefa_pi2

# Hide Streamlit UI elements for clean embedding
st.set_page_config(
    page_title="Spending Alignment with Priorities",
    layout="wide",
