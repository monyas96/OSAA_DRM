...
from app.pages.pb_graph_helpers import render_market_capitalization
...
fig = render_market_capitalization(df_filtered, ref_data)
...
if fig:
    ...
    st.info("No data available for Market Capitalization indicator")
