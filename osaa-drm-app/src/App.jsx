...
import Topic41Page from './pages/Topic41Page'
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        {/* Topic 4.1 uses React page */}
        <Route path="/topic/4.1" element={<Topic41Page />} />
        {/* Policy Brief 4.1 */}
        ...
        {/* Redirect /topic/4.1 to React page */}
        <Route path="/streamlit/topic-4-1" element={<Navigate to="/topic/4.1" replace />} />
