...
from app.pages.pb_graph_helpers import render_tax_gap
...
fig = render_tax_gap(df_filtered, ref_data)
...
if fig:
    ...
    st.info("No data available for Tax Gap indicator")
