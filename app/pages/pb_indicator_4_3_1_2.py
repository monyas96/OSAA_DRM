...
from app.pages.pb_graph_helpers import render_portfolio_bonds
...
fig = render_portfolio_bonds(df_filtered, ref_data)
...
if fig:
    st.plotly_chart(fig, use_container_width=True, config={
        ...
        'toImageButtonOptions': {
            'format': 'png',
            'filename': 'portfolio_bonds_chart',
            'height': 800,
            'width': 1200,
            'scale': 1
        }
    ...
    st.info("No data available for Portfolio Investment Bonds indicator")
